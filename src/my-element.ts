			...
			<div class=${tw`bg-white p-8 max-w-4xl mx-auto rounded-xl shadow-lg`}>
				...
				<div class=${tw`mb-8`}>
					...
					<div class=${twMix`bg-blue-500/50 p-4 rounded-lg`}>
						<code class=${tw`font-mono text-red-500`}>bg-blue-500/50</code> →
						<code class=${tw`font-mono text-blue-500`}>
				...
				<div class=${tw`mt-8 p-4 bg-green-50 rounded-lg`}>
					<h2 class=${tw`text-lg font-semibold text-green-700 mb-2`}>
						🌍 Browser Support
					</h2>
